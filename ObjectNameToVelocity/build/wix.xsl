...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/wix:Wix">
    <Wix xmlns="http://schemas.microsoft.com/wix/2006/wi">
      <Product xmlns="http://schemas.microsoft.com/wix/2006/wi" Id="BF863D7C-60BB-4267-8D47-EEBFBEEEAAD5" Name="ObjectNameToVelocity " Language="1041" Codepage="932" Version="" Manufacturer="AIST" UpgradeCode="AED78F55-C998-480C-87FC-0D67D99B497F">
        <Package InstallerVersion="300" Compressed="yes" Languages='1041' SummaryCodepage='932' />
        <Media Id="1" Cabinet="ObjectNameToVelocity.cab" EmbedCab="yes" />
	  ...
	  -->
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, translate('\bin\ObjectNameToVelocity.dll','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'))]" />
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, translate('\lib\ObjectNameToVelocity.lib','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'))]" />
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, translate('\bin\ObjectNameToVelocityComp.exe','ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'))]" />
          <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, 'RTC.xml')]" />
        </Feature>
	...
	<!-- <Feature Id="SOURCES" Title="" Level="1" Absent="allow" Description="" >-->
          <!-- Start Ripping through the xml -->
	  <!-- <xsl:apply-templates select="wix:Fragment/wix:DirectoryRef/wix:Component[contains(wix:File/@Source, 'ObjectNameToVelocity100\src')]" /> -->
	  <!-- </Feature> -->
        ...
        <!-- 
        <WixVariable Id="WixUILicenseRtf" Value="C:/ObjectNameToVelocity/ObjectNameToVelocity/cmake/License.rtf"/>
        -->
